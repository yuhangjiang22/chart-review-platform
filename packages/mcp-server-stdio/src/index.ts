...
if (want("read_notes")) {
  server.registerTool(
    ...
    {
      description: [
        "PREFER OVER MULTIPLE read_note CALLS. Returns N chart notes in a",
        "single tool result. Each entry includes total_chars, returned_chars,",
        "and a truncated flag (per-note max_chars_per_note, default 8192).",
        "Use this when you want to skim every note at once — one round-trip",

...
// disagreements + low-confidence cells, writes
// <task>/pilots/<iter>/judge_analyses.json, and PatientReview reads
// that file to surface advisory panels.
//
...
interface PhaseJudgeProps {
  ...
  taskKind?: "phenotype";
  onOpenSpan?: (patientId: string) => void;
}
...
export function PhaseJudge({
  taskId, iterId, onSkipToValidate,
}: PhaseJudgeProps) {

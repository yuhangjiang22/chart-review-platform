...
```bash
cd /Users/yj38/Documents/Chart-Review-Agents-main/chart-review-platform-light
rm -rf var/reviews
```
...
- **Run all commands from** `chart-review-platform-light/`; git from the repo root `/Users/yj38/Documents/Chart-Review-Agents-main`.

...
//
// Clicking a row navigates into Studio at `#/studio/<task-id>`; the Studio
// view does the heavy lifting of loading the compiled task fields.
      ...
      {tasks.length === 0 ? (
        <Card>
          <CardContent className="py-10 text-center text-muted-foreground">
            ...
            <div className="text-[15px] text-foreground">No tasks yet.</div>
        ...
        <div className="flex flex-1 items-center gap-4 px-4 py-3.5">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            ...
            <div className="mt-1 flex items-center gap-2 text-[12px] text-muted-foreground">
              <span className="tabular-nums">{task.field_count} fields</span>
              {task.task_type && (
                <>

...
## Definition
Liver stiffness **within 1 year** before the reference date: **VCTE (FibroScan)
...
## Examples
- "FibroScan: median LSM 18.5 kPa" (3mo before the reference date) -> `met`
- "MRE: liver stiffness 5.6 kPa" -> `met`
- "VCTE 9.8 kPa" -> `not_met`
- "FibroScan 14 kPa" 20 months before the reference date -> `not_met` (out of window)

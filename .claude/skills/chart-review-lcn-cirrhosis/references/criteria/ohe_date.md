...
## Definition
The date of the MOST RECENT documented overt hepatic encephalopathy event at ANY time ANYWHERE in the chart — before OR AFTER the index date; there is no time ceiling. Blank when never documented.

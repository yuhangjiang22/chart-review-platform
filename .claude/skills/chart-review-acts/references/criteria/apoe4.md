...
- `apoe_genotype = e3/e4` → `1` (ε4 present — principal AD risk allele)
- `apoe_genotype = e2/e3` → `0` (full genotype, no ε4)
- `apoe_genotype = e2_carrier` → `NA` (different-allele carrier; ε4 cannot be established)
